import {
  ...
  stopEvent,
  tabbable
} from "./chunk-LQV3546K.js";
import {
  Timeout,
  useTimeout
} from "./chunk-M555PV7T.js";
import {
  visuallyHidden
...
import {
  ...
  useTransitionStatus
} from "./chunk-DD4XWCA5.js";
import {
  useId
} from "./chunk-65YFOFST.js";
import {
  useOnMount
} from "./chunk-DDMVWXHT.js";
import {
...
var require_with_selector_development = __commonJS({
  "../../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React28 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef18 = React28.useRef, useEffect9 = React28.useEffect, useMemo17 = React28.useMemo, useDebugValue2 = React28.useDebugValue;
...
function fastComponentRef(fn) {
  return React8.forwardRef(fastComponent(fn));
}
...
function useHoverReferenceInteraction(context, props = {}) {
  ...
  const closeWithDelay = React16.useCallback((event, runElseBranch = true) => {
    const closeDelay = getDelay2(delayRef.current, "close", instance.pointerType);
    if (closeDelay && !instance.handler) {
      instance.openChangeTimeout.start(closeDelay, () => store.setOpen(false, createChangeEventDetails(reason_parts_exports.triggerHover, event)));
    } else if (runElseBranch) {
      instance.openChangeTimeout.clear();
  ...
  React16.useEffect(() => {
    ...
    function onMouseEnter(event) {
      ...
      const openDelay = getDelay2(delayRef.current, "open", instance.pointerType);
      const currentDomReference = store.select("domReferenceElement");
...
function useInteractions(propsList = []) {
  ...
  const getTriggerProps = React17.useCallback(
...
function useRole(context, props = {}) {
  ...
  const floatingId = React19.useMemo(() => {
    var _a;
  ...
  const item = React19.useCallback(({
    active,
    selected
  }) => {
    const commonProps = {
...
var FloatingDelayGroupContext = React21.createContext({
  hasProvider: false,
  timeoutMs: 0,
  delayRef: {
    current: 0
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CP3RU4GV.js.map
